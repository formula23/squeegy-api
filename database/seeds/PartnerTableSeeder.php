...
//        Partner::truncate();
        ...
        $partner = Partner::create([
            'name'=>"King's Arch - Wilshire",
            'location_name'=>"King's Arch - Wilshire",
            'location'=>[
                "city"=>"Beverly Hills",
                "lat" => 33.066798,
                "lon" => -118.384373,
                "street"=>"8820 Wilshire Blvd",
                "zip"=>"90211",
                "state"=>"CA"
            ],
            'geo_fence'=>'[{"lat":34.067051, "lng":-118.384680},{"lat":34.067052, "lng":-118.383701},{"lat":34.066479, "lng":-118.383679},{"lat":34.066475, "lng":-118.384646}]',
            'is_active'=>1,
        ]);
        ...
        $partner->days()->create([
            'day'=>'Friday',
            'day_of_week'=>5,
            'next_date'=>Carbon::createFromDate(2016, 8, 12),
            'time_start'=>'8:00am',
            'time_end'=>'5:00pm',
            'frequency'=>'bi-weekly',
        ]);
